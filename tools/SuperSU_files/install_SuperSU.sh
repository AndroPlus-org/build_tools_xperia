...
# ew gekürzt und angepasst für eine manuelle Installation für mein arm64 xperia Tablet Z4

# die Installationsdateien stehen im Verzeichnis /SuperSU_files (ggf. eine neue boot.img dafür bauen)
...
BIN=/SuperSU_files/$ARCH
COM=/SuperSU_files/common
